        ...
        <div className="px-4 pt-16 mt-20 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="mt-6 lg:max-w-sm">
                    ...
                    Várunk szeretettel, nyirass egy komoly pacekot!
                    </p>
                </div>
                ...
                <div className="flex">
                    ...
                    <a href="mailto:info@dudocutz.hu" aria-label="Our email" title="Our email" className="transition-colors duration-300  text-main-red">info@dudocutz.hu</a>
                </div>
                <div className="flex">
                    <p className="mr-1 text-gray-300">Cím:</p>
                    <a href="https://www.google.com/maps/search/Árpád+út+HSZ+523%2F10+Verőce+2621/@47.8225147,19.0280873,17z/data=!3m1!4b1?entry=ttu" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" className="transition-colors duration-300 text-main-red">
                ...
                <div className="flex items-center mt-1 space-x-3">
                    <a href="https://www.instagram.com/dudocutz" target='_blank' className="text-gray-300 transition-colors duration-300 hover:text-deep-purple-accent-400">
                    ...
                    <a href="https://www.facebook.com/dudocutz" target='_blank' className="text-gray-300 transition-colors duration-300 hover:text-deep-purple-accent-400">
            ...
            <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                ...
                <li>
                    <a href="/felhasznalasi_feltetelek" className="text-sm text-gray-300 transition-colors duration-300 hover:text-deep-purple-accent-400">Felhasználási feltételek</a>
                </li>
                </ul>
            </div>
            </div>
